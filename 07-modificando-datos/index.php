        ...
        try{
            ...
            while ($_fila = mysqli_fetch_array($_datos)){
                echo '<table><tr><td>'.
                        ...
                        mb_convert_encoding($_fila['mensaje'], 'UTF-8').'</td><td><a href="borrar.php?codigo='.$_fila["id"].'">Borrar</a></td><td><a href="actualizar.php?codigo='.$_fila["id"].'">Actualizar</a></td></tr></table>';
            }
